...
class PrecisionLanding:
    ...
    # class contructor
    def __init__(self, vehicle, device):
        self.kill = False
        self.device = device
        ...
        self.calib_path = "/home/gabriel/Documents/Speedbird.aero/cloud-control-vision/matrix/logitech_800_600/"
    ...
    def trackArucos(self, frame):
        ...
        try:
            ...
            if altitude > 6.0 and altitude <= 18.0:
                marker_to_find = 72
                marker_size = 40
            ...
            if ids is not None:
                for id in ids:
                    if id == marker_to_find and marker_size > 0:
    ...
    def processLanding(self):
        ...
        while True:
            ...
            try:
                ...
                resizedFrame = cv2.resize(frame, (1920, 920))
